...
function getCategories() {
    ...
    $.ajax({
        ...
        url: 'www.orderingapi.42web.io/ordering-api/index.php?r=site/categories',
        type: 'POST',
...
function getProducts(data) {
    ...
    $.ajax({
        ...
        url: 'www.orderingapi.42web.io/ordering-api/index.php?r=site/products',
        type: 'GET',
...
function getAllProducts() {
    ...
    $.ajax({
        ...
        url: 'www.orderingapi.42web.io/ordering-api/index.php?r=site/allProducts',
        type: 'POST',
        beforeSend: function () {
            $('#products').html('');
        },
